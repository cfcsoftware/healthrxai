...
export default function LoginPage() {
  ...
  // Remove isLoading since it's not used in the UI
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // setIsLoading(true); // Remove unused isLoading
    ...
    try {
      ...
      // Fix: Don't use 'any', use 'unknown' and type guard for error.message
      ...
      // setIsLoading(false); // Remove unused isLoading
    }
  };
