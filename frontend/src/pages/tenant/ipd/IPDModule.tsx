  ...
  const patients: Patient[] = [
    {
      ...
      age: 34,
      no:1,
      cosultantDoctor: 'Doctor 1',
      appointment: 'APT1001',
      gender: 'Male',
      address: '123, Green Avenue, Sector 45, New Delhi - 110045',
      admissionDate: '2025-07-09',
      status: 'admin@cityhospital.com',
      department: 'Cardiology',
      emergencyContact: '9876543212',
      bloodGroup: 'Gayatri Hospital Raipur',
      avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face'
    },
    {
      id: 2,
      patientId: 'admin@medicare.com',
    ...
    {
      id: 4,
      patientId: 'manager@clinicdemo.com',
    ...
    {
      id: 5,
      patientId: 'docjohn@healthcare.org',
  ...
  const filteredPatients = useMemo(() => {
    const filtered = patients.filter(patient => {
      const matchesSearch = patient.patientName.toLowerCase().includes(searchTerm.toLowerCase()) ||
                           ...
                           patient.ipdid.includes(searchTerm);
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200">
          ...
          <div className="p-6 border-b border-gray-200">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
              <div className="flex items-center space-x-4">
                <h3 className="text-lg font-semibold text-gray-900">IPD List</h3>
                  ...
                  <tr key={patient.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="text-sm font-medium text-gray-900">{patient.ipdid}</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <div className="text-sm font-medium text-gray-900 flex items-center space-x-1 mt-1">
                        <span className="truncate max-w-xs">{patient.patientName}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-medium text-gray-900">{patient.cosultantDoctor}</div>
                     
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900"> {patient.appointment}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium `}>
                        <span className="ml-1">{patient.ipdid}</span>
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
