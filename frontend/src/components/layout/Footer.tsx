...
export default function Footer() {
  ...
  return (
    <footer className="relative isolate overflow-hidden bg-black-500 border-t border-white/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center">
              <span className="flex items-center">
                ...
                <span className="ml-1 text-2xl font-bold text-white"></span>
              </span>
            </div>
            ...
            <div className="mt-4">
              <h3 className="text-sm font-semibold leading-6 text-white/80">Subscribe to our newsletter</h3>
              <form className="mt-2 flex max-w-md gap-x-4">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="min-w-0 flex-auto rounded-md border-0 bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-white/30 sm:text-sm sm:leading-6"
                  placeholder="Enter your email"
                />
                <button
                  type="submit"
                  className="flex-none rounded-md bg-white/10 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-white/20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
                >
                  Subscribe
                </button>
              </form>
          ...
          {columns.map((column, index) => (
            <div key={index} className="space-y-4">
              <h3 className="text-sm font-semibold leading-6 text-white/80 tracking-wider uppercase">
                {column.title}
              </h3>
                  ...
                  <li key={linkIndex}>
                    {link.external ? (
                      <a
                        ...
                        className="text-sm leading-6 text-white/70 hover:text-white transition-colors duration-200"
                      >
                        {link.label}
                      </a>
                    ) : (
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 text-sm text-white/80">
              ...
              <div className="flex items-center">
                ...
                <a href="mailto:info@healthrxai.com" className="hover:text-white transition-colors duration-200">info@healthrxai.com</a>
              </div>
            </div>
          </div>
